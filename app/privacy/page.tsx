    ...
    <div className="min-h-screen bg-white text-black">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="space-y-6 text-sm leading-relaxed">
          ...
          <p>• 为反作弊与崩溃统计，TapSDK 会收集 IP、OAID、Android ID、系统版本、错误日志；QZQ Studio 服务器端不保存上述数据，仅实时查看匿名汇总报表。</p>
          ...
          <p className="font-bold">1.6 第三方 SDK 信息收集披露</p>
          <p>本游戏集成了以下第三方 SDK，其各自独立收集相关信息，适用其自身的隐私政策：</p>
          <div className="ml-2 space-y-3 mt-1">
            <div>
              <p className="font-bold">① TapSDK（北京心动网络股份有限公司）</p>
              <p>• 收集信息：设备标识符（OAID、Android ID）、IP 地址、系统版本、崩溃日志及匿名统计数据。</p>
              <p>• 收集目的：提供账号登录与实名认证、云存档同步、反作弊检测及崩溃分析服务。</p>
              <p>• 隐私政策：<a href="https://www.taptap.cn/doc/current/store-privacy-security/privacy-policy.html" target="_blank" rel="noopener noreferrer" className="underline">https://www.taptap.cn/doc/current/store-privacy-security/privacy-policy.html</a></p>
            </div>
            <div>
              <p className="font-bold">② Epic Online Services SDK（Epic Games, Inc.，包名前缀：com.epicgames）</p>
              <p>• 收集信息：设备传感器数据（加速度计、陀螺仪等硬件传感器读数）。</p>
